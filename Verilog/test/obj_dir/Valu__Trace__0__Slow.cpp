...
VL_ATTR_COLD void Valu___024root__trace_init_sub__TOP__0(Valu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+9,"a_in", false,-1, 7,0);
    tracep->declBus(c+10,"b_in", false,-1, 7,0);
    ...
    tracep->declBus(c+2,"a_in_r", false,-1, 7,0);
    tracep->declBus(c+3,"b_in_r", false,-1, 7,0);
    tracep->declBit(c+4,"in_valid_r", false,-1);
    tracep->declBus(c+5,"result", false,-1, 7,0);
...
VL_ATTR_COLD void Valu___024root__trace_full_sub_0(Valu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+2,(vlSelf->alu__DOT__a_in_r),8);
    bufp->fullCData(oldp+3,(vlSelf->alu__DOT__b_in_r),8);
    bufp->fullBit(oldp+4,(vlSelf->alu__DOT__in_valid_r));
    bufp->fullCData(oldp+5,(vlSelf->alu__DOT__result),8);
