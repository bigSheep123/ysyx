...
#endif
                VL_FATAL_MT("alu.sv", 7, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Valu___024root___stl_sequent__TOP__0(Valu___024root* vlSelf) {
    ...
    if (vlSelf->alu__DOT__in_valid_r) {
        vlSelf->alu__DOT__result = (0xffU & ((1U == (IData)(vlSelf->alu__DOT__op_in_r))
...
VL_ATTR_COLD void Valu___024root___ctor_var_reset(Valu___024root* vlSelf) {
    ...
    vlSelf->alu__DOT__a_in_r = VL_RAND_RESET_I(8);
    vlSelf->alu__DOT__b_in_r = VL_RAND_RESET_I(8);
    vlSelf->alu__DOT__in_valid_r = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__result = VL_RAND_RESET_I(8);
